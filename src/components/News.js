    ...
    <div>
       ...
       <br/> 
          ...
          <div className="flex" id="rokkitt">
            ...
            <h1>Want Free Stuff?!! <a className="red" href="https://flowingfreeride.com/free-snowboard-tips/" target="blank">
                  Click For Free Snowboard News, Tips & Bribes!!</a>
            </h1>
            </div>
          <div id="container">
<p className="p"><a href="https://flowingfreeride.com/" target="blank">
